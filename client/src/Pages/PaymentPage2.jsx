            ...
            <div>
                ...
                <form action="" className=" pb-5 pt-10 m-5 sm:m-0">
                    <div action="" className=" bg-slate-950/30 max-w-lg mx-auto p-7 space-y-2 rounded-xl pt-10">
                        <div className=" font-semibold flex justify-between items-center bg-gradient-to-r p-5 rounded text-xl"><div>PLATINUM PLANE</div> <div className=" text-teal-400 text-2xl">Rs. 40,000</div></div>
