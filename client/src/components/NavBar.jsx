...
const NavBar = () => {
    ...
    return (
        <div className=" flex fixed top-0 left-0 right-0 z-50 w-full justify-between items-center px-6 py-3 text-white bg-gradient-to-r from-blue-900 to-violet-900">
