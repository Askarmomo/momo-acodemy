...
const HomePage = () => {
    ...
    return (
        <div>
            ...
            <div className=" pt-60 pl-40  text-white bg-[url('src/images/2151005751.jpg')]  min-h-screen">
            ...
            <div className=" flex justify-between pt-20 items-center cursor-pointer dark:bg-blue-900 px-28 ">
                <div className=" flex bg-slate-500/20 text-white gap-5 border rounded-xl p-5 items-center" data-aos="zoom-out-right">
                    ...
                    <div>
                        <h1 className=" font-semibold text-xl pb-3"> 2+ Hours Dayly Live Setion</h1>
                        <small className=" text-gray-300">Every sunday To Friday Live Setion <br /> Morning 1 Hours Eavining 1 Hour</small>
                    </div>
                </div>
                <div className=" flex bg-slate-500/20 text-white border p-5 rounded-xl gap-5 items-center" data-aos="fade-up">
                    ...
                    <div>
                        <h1 className=" font-semibold text-xl pb-3">SMC + Market Language</h1>
                        <small className=" text-gray-300">SMC All Concept And Pshycholegy <br />And Our Facing Market Languages</small>
                    </div>
                </div>
                <div className=" flex bg-slate-500/20 text-white border gap-5 items-center rounded-xl p-5" data-aos="zoom-out-left">
                    ...
                    <div>
                        <h1 className=" font-semibold text-xl pb-3"> Life Time Access</h1>
            ...
            <div className=" dark:bg-blue-900 ">
                ...
                <div className=" flex bg-gradient-to-r from-blue-500/30 to-violet-500/30 border py-5 px-3  rounded-lg  " data-aos="fade-up">
                    <img className=" object-cover h-[480px]" src="src/images/pexels-george-morina-4960396.jpg" alt="" />
                    <div className=" p-14 space-y-5">
                        ...
                        <div className=" text-white flex gap-5 font-semibold"><img className=" w-6" src="src/images/check-mark_2714-fe0f.png" alt="" /> Introduction of the Market </div>
                        <div className=" text-white flex gap-5 font-semibold"><img className=" w-6" src="src/images/check-mark_2714-fe0f.png" alt="" />Market Structured</div>
                        <div className=" text-white flex gap-5 font-semibold"><img className=" w-6" src="src/images/check-mark_2714-fe0f.png" alt="" />  Suply And Demand</div>
                        <div className=" text-white flex gap-5 font-semibold"><img className=" w-6" src="src/images/check-mark_2714-fe0f.png" alt="" />Liqudity</div>
                        <div className=" text-white flex gap-5 font-semibold"><img className=" w-6" src="src/images/check-mark_2714-fe0f.png" alt="" />Risk And Money Management</div>
                        <div className=" text-white flex gap-5 font-semibold"><img className=" w-6" src="src/images/check-mark_2714-fe0f.png" alt="" />Psicholegy</div>
                        <div className=" text-white flex gap-5 font-semibold"><img className=" w-6" src="src/images/check-mark_2714-fe0f.png" alt="" />Our Poin Of Viewes In Market</div>
                    </div>
                </div>
            </div>
            <div className=" bg-blue-950 text-white">
                <h1 className=" font-semibold text-3xl text-center py-10" data-aos="fade-up">Our Teaching Profational</h1>
                <div className=" flex items-center gap-5 border bg-gradient-to-r from-blue-500/30 to-violet-500/30 rounded-xl mx-20 p-5" data-aos="fade-up">
            ...
            <div className=" bg-blue-950 text-white">
                ...
                <div className=" flex justify-between gap-10 items-center px-20">
                    <div className=" border p-5 rounded-xl bg-gradient-to-r from-blue-900 to-violet-900" data-aos="zoom-out-right">
                        <div className="pl-40"><svg className=" text-teal-400" xmlns="http://www.w3.org/2000/svg" width="10em" height="10em" viewBox="0 0 24 24"><path fill="currentColor" d="m12 6.7l1.45 3.85L17.3 12l-3.85 1.45L12 17.3l-1.45-3.85L6.7 12l3.85-1.45zM12 1L9 9l-8 3l8 3l3 8l3-8l8-3l-8-3z"></path></svg></div>
                        <h1 className=" text-2xl font-semibold py-5">PLATINUM PLANE</h1>
                        <div className=" font-semibold text-4xl flex items-center gap-3">Rs. 10,000 <div className=" text-lg opacity-75" >( 1 Year Service )</div></div>
                        <div className=" font-semibold text-lg pb-5 pt-1"><s className=" text-teal-600">Rs. 12,000</s> 10% Off for first 100 members</div>
                    ...
                    <div className=" border p-5 rounded-xl bg-gradient-to-r from-blue-900 to-violet-900" data-aos="zoom-out-left">
                        <div className="pl-40"><svg className=" text-yellow-500" xmlns="http://www.w3.org/2000/svg" width="10em" height="10em" viewBox="0 0 24 24"><path fill="currentColor" d="m1 22l1.5-5h7l1.5 5zm12 0l1.5-5h7l1.5 5zm-7-7l1.5-5h7l1.5 5zm17-8.95l-3.86 1.09L18.05 11l-1.09-3.86l-3.86-1.09l3.86-1.09l1.09-3.86l1.09 3.86z"></path></svg></div>
                        <h1 className=" text-2xl font-semibold py-5">GOLD PLANE</h1>
                        <div className=" font-semibold text-4xl flex gap-3 items-center ">Rs. 40,000 <div className=" text-lg opacity-75">( Unlimited Service )</div></div>
                        <div className=" font-semibold text-lg pb-5 pt-1"><s className=" text-teal-600">Rs. 45,000</s> 5% Off for first 100 members</div>
