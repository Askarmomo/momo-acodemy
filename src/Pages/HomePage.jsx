...
const HomePage = () => {
    ...
    return (
        <div className=' bg-blue-900'>
            ...
            <div className=" flex justify-between pt-10 pb-10 items-center cursor-pointer bg-blue-950 px-28 ">
                <div className=" flex bg-slate-900 text-white gap-5 border rounded-xl p-5 items-center" data-aos="zoom-out-right">
                ...
                <div className=" flex bg-slate-900 text-white border p-5 rounded-xl gap-5 items-center" data-aos="fade-up">
                ...
                <div className=" flex bg-slate-900 text-white border gap-5 items-center rounded-xl p-5" data-aos="zoom-out-left">
            ...
            <div className=" bg-blue-950 text-white pb-20">
                ...
                <div className=" flex justify-between gap-10 items-center px-20">
                    ...
                    <div className=" border p-5 rounded-xl bg-gradient-to-r from-blue-900 to-violet-900" data-aos="zoom-out-left">
                        ...
                        <div className=" font-semibold text-lg pb-5 pt-1"><s className=" text-teal-600">Rs. 45,000</s> 5% Off</div>
