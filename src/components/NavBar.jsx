...
const NavBar = () => {
    ...
    return (
        <div className=" flex justify-between items-center px-6 py-3 text-white bg-gradient-to-r from-blue-900 to-violet-900 sticky top-0 z-50">
            ...
            <div className={` ${nave ? "hidden" : " block"} absolute sm:static right-5 left-0 text-center top-[70px] w-full sm:w-96  bg-black sm:bg-transparent sm:flex sm:justify-between font-semibold sm:gap-10`}>
