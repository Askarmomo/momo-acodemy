const NavBar = () => {
    return (
        <div className=" flex justify-between items-center p-5 text-white bg-gradient-to-r from-blue-500 to-violet-500"> 
            <div className=" flex gap-1 items-center"> 
                <a href="#" className=" text-4xl font-semibold font-sans ">MOMO</a>
            ...
            <div className=" flex justify-between font-semibold gap-10 items-center">
                <div className=" rounded px-7 bg-cyan-500 cursor-pointer  py-2 transition ease-in-out hover:scale-110 duration-500"><a href="#">Join</a></div>
                <div className=" border border-cyan-500 rounded px-7 cursor-pointer py-2 hover:bg-cyan-500 duration-300 ease-in-out"><a href="#">Log In</a></div>
            </div>
        </div>
    );
}
